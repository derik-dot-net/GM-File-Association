...
var file_association_flag_exists = file_exists_ns(file_association_flag_path);
...
if associated_file_path != undefined {
	buffer_load_ns(associated_file_path);//just as an example, load the file from this path however you need to
